            ...
            <div className="relative bg-primary py-20">
                <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="text-white max-w-2xl">
                        <h1 className="text-4xl font-bold mb-4">Fever Profile Basic</h1>
                        <p className="text-blue-100 text-lg">Initial screening for identifying the cause of fever.</p>
                    </div>
            ...
            <div className="container mx-auto max-w-7xl px-4 py-12">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {[
                        ...
                        { name: "Peripheral Smear", desc: "Blood cell morphology" },
                        { name: "ESR", desc: "Inflammation marker" },
                        { name: "Widal Slide Method", desc: "Typhoid screening" },
                        { name: "Malaria Antigen", desc: "Vivax & Falciparum" },
                        { name: "Urine Analysis", desc: "Infection screening" },
                    ].map((test, idx) => (
