        ...
        <div className="min-h-screen bg-slate-50 pt-20 font-sans">
            <div className="relative bg-primary py-20">
                <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="text-white max-w-2xl">
                        <h1 className="text-4xl font-bold mb-4">Diabetic Profile</h1>
                        <p className="text-blue-100 text-lg">Specialized monitoring for diabetes management.</p>
                    </div>
            ...
            <div className="container mx-auto max-w-7xl px-4 py-12">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {[
                        { name: "Fasting Blood Sugar", desc: "Glucose level after fasting" },
                        { name: "HbA1c", desc: "Average blood sugar (3 months)" },
                        { name: "Lipid Profile", desc: "Cholesterol & Triglycerides" },
                        { name: "Serum Creatinine", desc: "Kidney function" },
                        { name: "Uric Acid", desc: "Gout risk & kidney health" },
                        { name: "Microalbumin (Urine)", desc: "Early kidney damage sign" },
