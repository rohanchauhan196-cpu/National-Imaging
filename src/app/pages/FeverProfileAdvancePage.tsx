            ...
            <div className="relative bg-primary py-20">
                <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="text-white max-w-2xl">
                        <h1 className="text-4xl font-bold mb-4">Fever Profile Advance</h1>
                        <p className="text-blue-100 text-lg">Comprehensive investigation for persistent or high fever.</p>
                    </div>
            ...
            <div className="container mx-auto max-w-7xl px-4 py-12">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {[
                        ...
                        { name: "Urine Analysis", desc: "Routine usage" },
                        { name: "Widal Slide Method", desc: "Typhoid" },
                        { name: "Malaria Antigen", desc: "Vivax & Falciparum" },
                        { name: "CRP (Quantative)", desc: "Inflammation level" },
                        { name: "Blood Culture & Sensitivity", desc: "Bacterial infection check" },
                    ].map((test, idx) => (
